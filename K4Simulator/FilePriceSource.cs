...
namespace KTASimulator
{
    ...
    public class FilePriceSource
    {
        ...
        public FilePriceSource(KTASimulator simulator, ILog log)
        {
        ...
        private KaiTrade.Interfaces.IProduct GetProductFromXML(string xmlData)
        {
        ...
        private void setupProduct(string line)
        {
            try
            {
                ...
                if (!m_Simulator.Markets.ContainsKey(product.Mnemonic))
                {
