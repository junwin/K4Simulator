...
namespace SimulatorTest
{
    ...
    public class OrderTest
    {
        ...
        private static KTASimulator.KTASimulator _driver = null;
        ...
        public void SubmitOrderSimInBook()
        {
            ...
            msg.ClientID = MQExchanges.DEFAULT;
            msg.ClientSubID = MQRoutingKeyPrefix.INFO;
            msg.CorrelationID = "99";
        ...
        public void SubmitOrderSimMarket()
        {
            ...
            var pm = new DriverBase.ProductManager(log);
            // AAB will just be put into the simulators internal book
            _driver = new KTASimulator.KTASimulator(log);
            _driver.TimerInterval = 1000;
            ...
            List<IProduct> products = _driver.ProductManager.GetProducts("KTASIM", "", "");
